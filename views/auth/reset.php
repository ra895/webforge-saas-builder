...
<head>
    ...
    <title>Reset Password - WebForge</title>
...
<div class="reset-card text-center">
    ...
    <p class="text-muted small mb-4">Please input your new account security credentials below.</p>
    ...
    <form method="POST" action="<?= APP_URL ?>/auth/reset">
        <?= csrf_field() ?>
